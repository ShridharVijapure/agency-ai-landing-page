    ...
    return (
        <div
            ...
            <motion.div
                ...
                viewport={{ once: true }}  //it will display the animation only once
            ...
            <motion.h1
                ...
                <span className='bg-linear-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'>digital
            ...
            <motion.div
                ...
                <img src={assets.bgImage1} className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden'></img>
                {/* dark:hidden = so for the dark mode the image will be hidden */}
            </motion.div>
        </div>
    )
}
...
//after complete writing this code we need to mount this in app.jsx file.
//mount after hero component
