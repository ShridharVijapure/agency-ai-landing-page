...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    //event.preventDefault(); this will prevent the webpage from reloading  
    event.preventDefault();

    const formData = new FormData(event.target);

    formData.append("access_key", "87ddd1e9-6188-4213-b416-044dbb318883");
    ...
    >
      ...
      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <div>
          ...
          <div className='flex pl-3 rounded-lg border border-gary-300 dark:border-gray-600'>
        ...
        <div>
          <p className='mb-2 text-sm front-medium'>Your email</p>
          <div className='flex pl-3 rounded-lg border border-gary-300 dark:border-gray-600'>
        ...
        <button
          ...
          Submmit <img src={assets.arrow_icon} alt="" className='w-4' />
        </button>
      </form>
